...
const resources = {
  en: {
    translation: {
      ...
      "view_profile.rank_2": "Grandmaster",
      "view_profile.rank_3": "Master",
      "view_profile.rank_4": "Diamond",
      "view_profile.rank_5": "Platinum",
      "view_profile.rank_6": "Gold",
      "view_profile.rank_7": "Silver",
      "view_profile.rank_8": "Bronze",
      "view_profile.rank_9": "Cadet",
      "view_profile.rank_10": "Recruit",

      // TotalStat
      "total_stat.title": "Total stats",
      "total_stat.place": "Place",
      "total_stat.player": "Player",
      "total_stat.total_matches": "Matches",
      "total_stat.wins": "Wins",
      "total_stat.score": "Score",
      "total_stat.load_more": "Load more",
      "total_stat.level": "Level",
      ...
      "matches.finished_at": "Finished at",
      "matches.result": "Result",
      "matches.score": "Score",
      "matches.other_players": "Players",
      "matches.user_matches_title": "Matches of {{username}}",
      "matches.win": "Won",
      "matches.loss": "Lost",
      "matches.in_progress": "In progress",
  ...
  fr: {
    translation: {
      ...
      "view_profile.rank_2": "Grand maitre",
      "view_profile.rank_3": "Maitre",
      "view_profile.rank_4": "Diamant",
      "view_profile.rank_5": "Platine",
      "view_profile.rank_6": "Or",
      "view_profile.rank_7": "Argent",
      "view_profile.rank_8": "Bronze",
      "view_profile.rank_9": "Cadet",
      "view_profile.rank_10": "Recrue",
      ...
      "matches.finished_at": "Termine le",
      "matches.result": "Resultat",
      "matches.score": "Score",
      "matches.other_players": "Joueurs",
      "matches.user_matches_title": "Matchs de {{username}}",
      "matches.win": "Victoire",
      "matches.loss": "Defaite",
      "matches.in_progress": "En cours",
  ...
  ru: {
    translation: {
      ...
      "view_profile.rank_2": "Грандмастер",
      "view_profile.rank_3": "Мастер",
      "view_profile.rank_4": "Алмаз",
      "view_profile.rank_5": "Платина",
      "view_profile.rank_6": "Золото",
      "view_profile.rank_7": "Серебро",
      "view_profile.rank_8": "Бронза",
      "view_profile.rank_9": "Кадет",
      "view_profile.rank_10": "Новобранец",
      ...
      "matches.finished_at": "Завершен",
      "matches.result": "Результат",
      "matches.score": "Счет",
      "matches.other_players": "Игроки",
      "matches.user_matches_title": "Матчи пользователя {{username}}",
      "matches.win": "Победа",
      "matches.loss": "Поражение",
      "matches.in_progress": "В процессе",
