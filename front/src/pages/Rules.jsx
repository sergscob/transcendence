		...
		<div className="w-full h-full overflow-y-auto px-4 py-10 flex flex-col items-center">
			<div className="flex flex-col gap-6 w-full max-w-4xl border border-gray-600 rounded-xl p-6 md:p-10 shadow-2xl bg-gray-800 relative">	
				...
				<div className="flex flex-col gap-3 text-gray-200 text-base md:text-lg bg-gray-700 p-6 rounded-lg border border-gray-600 shadow-inner">
					<h3 className="text-xl md:text-2xl font-bold text-red-400 border-b border-gray-500 pb-2">
						1. {t("rules.objective")}
					</h3>
				...
				<div className="flex flex-col gap-3 text-gray-200 text-base md:text-lg bg-gray-700 p-6 rounded-lg border border-gray-600 shadow-inner">
					...
					<ul className="space-y-4">
						<li>
							<strong className="text-yellow-200 uppercase tracking-wider text-sm mr-2">{t("rules.loadout_lives_title")} :</strong>
							<span className="text-gray-300">{t("rules.loadout_lives_content")}</span>
						</li>
						<li>
							<strong className="text-yellow-200 uppercase tracking-wider text-sm mr-2">{t("rules.loadout_ammo_title")} :</strong>
							<span className="text-gray-300">{t("rules.loadout_ammo_content")}</span>
						</li>
						<li>
							<strong className="text-yellow-200 uppercase tracking-wider text-sm mr-2">{t("rules.loadout_lobby_title")} :</strong>
				...
				<div className="flex flex-col gap-3 text-gray-200 text-base md:text-lg bg-gray-700 p-6 rounded-lg border border-gray-600 shadow-inner">
					...
					<ul className="space-y-4">
						<li>
							<strong className="text-green-300 uppercase tracking-wider text-sm mr-2">{t("rules.controls_wasd")} :</strong>
							<span className="text-gray-300">{t("rules.controls_movements")}</span>
						</li>
						<li>
							<strong className="text-green-300 uppercase tracking-wider text-sm mr-2">{t("rules.controls_spacebar")} :</strong>
							<span className="text-gray-300">{t("rules.controls_jump")}</span>
						</li>
						<li>
							<strong className="text-green-300 uppercase tracking-wider text-sm mr-2">{t("rules.controls_leftclick")} :</strong>
				...
				<div className="flex flex-col gap-3 text-gray-200 text-base md:text-lg bg-gray-700 p-6 rounded-lg border border-gray-600 shadow-inner">
					...
					<ul className="space-y-4">
						<li>
							<strong className="text-blue-300 uppercase tracking-wider text-sm mr-2">{t("rules.multiplayer_serversetup")} :</strong>
							<span className="text-gray-300">{t("rules.multiplayer_serversetup_content")}</span>
						</li>
						<li>
							<strong className="text-blue-300 uppercase tracking-wider text-sm mr-2">{t("rules.multiplayer_createroom")} :</strong>
							<span className="text-gray-300">{t("rules.multiplayer_createroom_content")}</span>
						</li>
						<li>
							<strong className="text-blue-300 uppercase tracking-wider text-sm mr-2">{t("rules.multiplayer_joinmatch")} :</strong>
							<span className="text-gray-300">{t("rules.multiplayer_joinmatch_content")}</span>
						</li>
						<li>
							<strong className="text-blue-300 uppercase tracking-wider text-sm mr-2">{t("rules.multiplayer_startgame")} :</strong>
				...
				<div className="flex flex-col gap-3 text-gray-200 text-base md:text-lg bg-gray-700 p-6 rounded-lg border border-gray-600 shadow-inner">
					...
					<p className="leading-relaxed">
						{t("rules.interface_content")}
					</p>
					<img
						src={gameScreenshot}
						alt="Screenshot from the game"
						className="object-contain mb-8 pointer-events-none"
					/>
				</div>
			</div>
		</div>
